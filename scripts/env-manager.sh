...
init_variable_mappings() {
    # Core Automagik Service mappings (automagik_flashed)
    VARIABLE_MAPPINGS["automagik_flashed:AUTOMAGIK_AGENTS_API_PORT"]="AUTOMAGIK_API_PORT"
    VARIABLE_MAPPINGS["automagik_flashed:AUTOMAGIK_AGENTS_API_HOST"]="AUTOMAGIK_API_HOST"
    VARIABLE_MAPPINGS["automagik_flashed:AUTOMAGIK_AGENTS_URL"]="AUTOMAGIK_API_URL"
